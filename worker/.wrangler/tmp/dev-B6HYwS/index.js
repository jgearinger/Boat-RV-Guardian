...
// .wrangler/tmp/bundle-OoNV9x/checked-fetch.js
...
// .wrangler/tmp/bundle-OoNV9x/strip-cf-connecting-ip-header.js
...
async function getLinkTapConfigFromFirestore(env, token, uid) {
...
__name(getLinkTapConfigFromFirestore, "getLinkTapConfigFromFirestore");
async function triggerLinkTapShutoff(config) {
  const payload = {
...
__name(triggerLinkTapShutoff, "triggerLinkTapShutoff");
var src_default = {
...
// .wrangler/tmp/bundle-OoNV9x/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-OoNV9x/middleware-loader.entry.ts
